   ...
   if($old_pass != $empty_pass){
      if($old_pass != $prev_pass){
         ...
         if($new_pass != $empty_pass){
            ...
            $message[] = 'mohon masukan password baru anda!';
         }
      }
   }
...
<section class="form-container" style="min-height: calc(100vh - 19rem);">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="col">
               <p>password lama</p>
               <input type="password" name="old_pass" placeholder="masukan password lama anda" maxlength="50" class="box">
               <p>password baru</p>
               <input type="password" name="new_pass" placeholder="masukan password baru anda" maxlength="50" class="box">
