...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="home.php" class="logo"><img src="images/userlogo.png" alt=""></a>
      

      <form action="search_course.php" method="post" class="search-form">
         <input type="text" name="search_course" placeholder="Telusuri" required maxlength="100">
      ...
      <div class="profile">
         ...
         <span>Orang Biasa</span>
         <a href="profile.php" class="btn">Lihat Profil</a>

         <a href="components/user_logout.php" onclick="return confirm('logout from this website?');" class="delete-btn">Keluar</a>
         <?php
            }else{
         ?>
...
<div class="side-bar">
   ...
   <nav class="navbar">
      ...
      <a href="teachers.php"><i class="fas fa-chalkboard-user"></i><span>Para Sepuh</span></a>
