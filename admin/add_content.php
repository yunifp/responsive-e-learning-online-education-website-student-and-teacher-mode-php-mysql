...
<section class="video-form">
   ...
   <h1 class="heading">upload konten</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="title" maxlength="100" required placeholder="masukan judul video" class="box">
      <p>deskripsi video <span>*</span></p>
      <textarea name="description" class="box" required placeholder="masukan deskripsi video" maxlength="1000" cols="30" rows="10"></textarea>
      ...
      <select name="playlist" class="box" required>
         ...
         <?php
            ...
            echo '<option value="" disabled>belum ada playlist yang dibuat, mohon buat playlist sebelum mengunggah video!</option>';
         }
         ?>
      </select>
