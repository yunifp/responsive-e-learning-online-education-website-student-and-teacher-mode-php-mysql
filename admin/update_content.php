...
if(isset($_POST['update'])){
   ...
   $message[] = 'video/konten berhasil diperbarui!';
...
<head>
   ...
   <title>perbarui video/konten</title>
...
<section class="video-form">
   ...
   <h1 class="heading">perbarui video/konten</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="title" maxlength="100" required placeholder="masukan judul video" class="box" value="<?= $fecth_videos['title']; ?>">
      <p>perbarui deskripsi <span>*</span></p>
      <textarea name="description" class="box" required placeholder="masukan deskripsi video" maxlength="1000" cols="30" rows="10"><?= $fecth_videos['description']; ?></textarea>
      <p>perbarui playlist</p>
      <select name="playlist" class="box">
         ...
         <?php
            ...
            echo '<option value="" disabled>tidak ada playlist!</option>';
         }
         ?>
      </select>
      <img src="../uploaded_files/<?= $fecth_videos['thumb']; ?>" alt="">
      <p>perbarui thumbnail</p>
      ...
      <div class="flex-btn">
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="option-btn">lihat konten/video</a>
   ...
   <?php
         ...
         echo '<p class="empty">video/konten tidak ditemukan! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">add videos</a></p>';
      }
   ?>
