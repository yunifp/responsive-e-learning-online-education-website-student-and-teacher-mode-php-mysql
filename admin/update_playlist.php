...
<section class="playlist-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="title" maxlength="100" required placeholder="masukan judul playlist" value="<?= $fetch_playlist['title']; ?>" class="box">
      <p>deskripsi playlist <span>*</span></p>
      <textarea name="description" class="box" required placeholder="masukan deskripsi playlist" maxlength="1000" cols="30" rows="10"><?= $fetch_playlist['description']; ?></textarea>
   ...
   <?php
      ...
      echo '<p class="empty">tidak ada playlist yang ditambahkan!</p>';
   }
   ?>
