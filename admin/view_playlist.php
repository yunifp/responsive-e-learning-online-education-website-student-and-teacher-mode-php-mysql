...
<section class="playlist-details">
   ...
   <?php
         ...
         echo '<p class="empty">tidak ada playlist yang ditemukan, mungkin anda belum buat kali!</p>';
      }
   ?>
...
<section class="contents">
   ...
   <?php
         ...
         echo '<p class="empty">video tidak ada, bikin aja belum! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">add videos</a></p>';
      }
   ?>
