...
if(isset($_POST['delete_comment'])){
   ...
   if($verify_comment->rowCount() > 0){
      ...
      $message[] = 'komentar telah terhapus!';
   }
...
if(isset($_POST['update_now'])){
   ...
   if($verify_comment->rowCount() > 0){
      ...
      $message[] = 'komentar telah berhasil diedit!';
   }
...
<section class="comments">
   ...
   <div class="show-comments">
      ...
      <div class="box" style="<?php if($fetch_comment['user_id'] == $user_id){echo 'order:-1;';} ?>">
         <div class="content"><span><?= $fetch_comment['date']; ?></span><p> - <?= $fetch_content['title']; ?> - </p><a href="watch_video.php?get_id=<?= $fetch_content['id']; ?>">lihat komentar</a></div>
      ...
      <?php
         ...
         echo '<p class="empty">komentar belum ditambahkan!</p>';
      }
      ?>
      </div>
