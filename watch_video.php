...
if(isset($_POST['add_comment'])){
   ...
   if($user_id != ''){
      ...
      if($select_content->rowCount() > 0){
         ...
         $message[] = 'ada sesuatu yang salah sus!';
      }

   }else{
      $message[] = 'mohon login/daftar terlebih dahulu!';
   }
...
<section class="edit-comment">
   ...
   <form action="" method="post">
      ...
      <textarea name="update_box" class="box" maxlength="1000" required placeholder="silahkan berkomentar sesuka hati" cols="30" rows="10"><?= $fetch_edit_comment['comment']; ?></textarea>
      <div class="flex">
...
<section class="watch-video">
   ...
   <?php
         ...
         echo '<p class="empty">tidak ada video yang ditambahkan!</p>';
      }
   ?>
...
<section class="comments">
   ...
   <form action="" method="post" class="add-comment">
      ...
      <textarea name="comment_box" required placeholder="Silahkan berkomentar sesuka hati.." maxlength="1000" cols="30" rows="10"></textarea>
